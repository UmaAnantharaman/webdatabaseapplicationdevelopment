  ...
  // Destroys the servlet.
   ...
   protected void processRequest(HttpServletRequest 
	 ...
	 try { 
	      ...
	      mycommand= (FrontControllerInterface) new InsertItem(); // Abstract avoids the refresh problem in 1st 2 mvc pattern
		 ...
		 page = mycommand.execute(request, response); // execute returns a string page,we store it in variable page and give it to dispatch as a parameter
